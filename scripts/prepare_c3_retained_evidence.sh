...
# The rendered IG site, temporary Jekyll tree and terminology cache are build
# products rather than review evidence. Retain the compact package, generated
# conformance resources, logs, summaries and OperationOutcomes instead.
rm -rf "$FHIR/output" "$FHIR/temp" "$FHIR/input-cache"
