...
def audit_event_resource(row: dict[str, Any]) -> dict[str, Any]:
    ...
    Exact BALP/IG conformance is deliberately deferred to v2.0.0.
    """
    return {
        ...
        "source": {"observer": {"display": row.get("source", "v2.0.0 smoke harness")}},
...
def envelope_from_row(row: dict[str, Any], pair: Any) -> dict[str, Any]:
    ...
    core["semantic_binding"] = {
        "fhir_release_hint": "VERIFY-v2.0.0",
