...
- `figures/outputs/figure1_boundary_architecture.pdf` (20198 bytes)
- `figures/outputs/figure1_boundary_architecture.png` (231774 bytes)
- `figures/outputs/figure1_boundary_architecture.svg` (66546 bytes)
- `figures/outputs/figure2_evidence_demotion_pipeline.pdf` (21711 bytes)
- `figures/outputs/figure2_evidence_demotion_pipeline.png` (208323 bytes)
- `figures/outputs/figure2_evidence_demotion_pipeline.svg` (72540 bytes)
- `figures/outputs/figure3_a2_merkle_flow.pdf` (24135 bytes)
- `figures/outputs/figure3_a2_merkle_flow.png` (237817 bytes)
- `figures/outputs/figure3_a2_merkle_flow.svg` (75990 bytes)
- `figures/outputs/figure4_workload_descriptors.pdf` (23461 bytes)
- `figures/outputs/figure4_workload_descriptors.png` (351261 bytes)
- `figures/outputs/figure4_workload_descriptors.svg` (101301 bytes)
- `figures/outputs/figure5_backend_decision_map.pdf` (14529 bytes)
- `figures/outputs/figure5_backend_decision_map.png` (298785 bytes)
- `figures/outputs/figure5_backend_decision_map.svg` (76471 bytes)
- `figures/scripts/generate_jcis_figures.py` (18681 bytes)
