...
Description: "AuditEvent profile for TrustEvidence emission and verification events. This draft FHIR IG draft adds an evidence-anchor extension while preserving the AuditEvent event-record role."
...
Description: "Provenance profile for TrustEvidence artefacts and evidence-anchor binding. This draft FHIR IG draft records the actors, entities, activity and policy references associated with the evidence artefact."
