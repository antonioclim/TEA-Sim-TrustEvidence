// draft FHIR IG examples. All fixture numerals, timestamps, identifiers and hashes are.
...
* extension[evidenceAnchor].extension[treeSize].valueUnsignedInt = 1001 //
...
* action = #R
* period.start = "2026-07-03T10:01:00Z" //
* recorded = "2026-07-03T10:01:00Z" //
* outcome = #0
...
* source.observer.identifier.value = "hapi-emitter-draft"
...
* entity[0].role = $ObjectRole#4 "domain resource" //
...
* extension[evidenceAnchor].extension[treeSize].valueUnsignedInt = 1002 //
...
* action = #C
* period.start = "2026-07-03T10:02:00Z" //
* recorded = "2026-07-03T10:02:00Z" //
* outcome = #0
* purposeOfEvent[0] = $PurposeOfUse#TREAT "TREAT"
* agent[0].who.identifier.system = "urn:te:actor"
...
* extension[evidenceAnchor].extension[treeSize].valueUnsignedInt = 1003 //
...
* action = #U
* period.start = "2026-07-03T10:03:00Z" //
* recorded = "2026-07-03T10:03:00Z" //
* outcome = #0
...
* extension[evidenceAnchor].extension[treeSize].valueUnsignedInt = 1004 //
...
* subtype = $RestfulInteraction#update "update"
* action = #U
* period.start = "2026-07-03T10:04:00Z" //
* recorded = "2026-07-03T10:04:00Z" //
* outcome = #0
* purposeOfEvent[0] = $PurposeOfUse#TREAT "TREAT"
* agent[0].who.identifier.system = "urn:te:actor"
...
* extension[evidenceAnchor].extension[treeSize].valueUnsignedInt = 1005 //
...
* subtype = $RestfulInteraction#read "read"
* action = #R
* period.start = "2026-07-03T10:05:00Z" //
* recorded = "2026-07-03T10:05:00Z" //
* outcome = #0
* purposeOfEvent[0] = $PurposeOfUse#TREAT "TREAT"
* agent[0].who.identifier.system = "urn:te:actor"
